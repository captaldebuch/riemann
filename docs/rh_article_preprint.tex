...
RvM Certificate Interface & 100\% & 0 & 0 & c498802 \\
RvM Local Argument Principle & 100\% & 0 & 0 & 6952273 \\
RvM von Mangoldt Boundary & 100\% & 0 & 0 & ec6584e \\
Finite Argument Principle Tool & 100\% & 0 & 0 & afbf82d \\
Isolating Analytic Factor Tool & 100\% & 0 & 0 & 8786b42 \\
Finite Analytic AP (ξ) & 100\% & 0 & 0 & d857085 \\
Rectangle Zero-Avoiding Levels & 100\% & 0 & 0 & 1998bd3 \\
Rectangle Finite Zero Sets & 100\% & 0 & 0 & f4832ab \\
Rectangle Deleted-Disk Geometry & 100\% & 0 & 0 & 5b5bd6d \\
Finite Deleted-Rectangle Witness & 100\% & 0 & 0 & 0254ce1 \\
\midrule
Final Analytic Gates & Foundation & — & — & 2 classical estimates \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
  ...
  \item \textbf{Finite Argument Principle with Multiplicities (\CodeName{FiniteArgumentPrinciple}):} A new Lean formalization of the argument principle for deleted-rectangle contours with explicit multiplicity-aware zero counting (commit \commit{afbf82d}). This is a foundational tool for local zero analysis.

  \item \textbf{Isolating Analytic Factor Extraction (\CodeName{IsolatingAnalyticFactor}):} A novel Lean technique for extracting concrete isolating balls from analytic order specifications, bridging abstract analytic properties to computable bounds (commit \commit{8786b42}).

  \item \textbf{ξ-Specific Finite Analytic Argument Principle (\CodeName{FiniteAnalyticArgumentPrinciple}):} Applies the finite argument principle directly to the ξ function, producing the residue decomposition required for RH reduction (commit \commit{d857085}). This is a reusable tool for Mathlib.
\end{enumerate}
